...
Group.new('Number', c.white, c.none, s.none)
...
Group.new('User1', c.red, c.none, s.none)
Group.new('User2', c.blue, c.none, s.none)
Group.new('User3', c.brick, c.none, s.none)
Group.new('Warning', c.dark, c.none, s.none)
...
Group.new('MatchParen', c.white, c.red, s.none)
...
Group.new('Visual', c.none, c.base:light(), s.none)
Group.new('VisualNOS', c.none, c.backgnd:light(), s.none)
Group.new('WildMenu', c.red, c.base, s.none)
Group.new('Blank', c.none, c.none, s.none)
...
Group.link('StorageClass', g.Tsoding)
...
Group.link('DiagnosticHint', g.Noise)
Group.link('DiagnosticInfo', g.Noise)
...
Group.link('GitSignsAdd', g.Number)
Group.link('GitSignsChange', g.Tsoding)
Group.link('GitSignsDelete', g.Error)

Group.new('IlluminatedWordText', c.none, c.backgnd:light(), s.none)
Group.new('IlluminatedWordRead', c.none, c.backgnd:light(), s.none)
Group.new('IlluminatedWordWrite', c.none, c.backgnd:light(), s.none)
